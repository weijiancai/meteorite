package com.meteorite.fxbase.ui.calendar;
...
//		this.prefWidthProperty().bind(dateTextWidth.add(10));
		...
		dateTxtField.setOnMouseClicked(new EventHandler<MouseEvent>() {
...
//		getChildren().addAll(dateTxtField, popupButton);
		getChildren().addAll(dateTxtField);
	}
